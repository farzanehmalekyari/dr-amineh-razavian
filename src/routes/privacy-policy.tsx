...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | Dr. Zahra Salehi" },
      { name: "description", content: "How Dr. Zahra Salehi's clinic collects, uses and protects your personal information." },
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24 prose-sm">
      ...
      <div className="mt-8 space-y-5 text-sm text-foreground/85 leading-relaxed">
        <p>This privacy policy explains how Dr. Zahra Salehi's clinic ("we", "our") collects, uses and safeguards information you provide when you use this website or book a consultation.</p>
        ...
        <p>Information shared in connection with a medical consultation is treated as confidential and stored securely. You may request access, correction or deletion at any time by contacting us.</p>
