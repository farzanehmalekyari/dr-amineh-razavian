...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | Dr. Amineh Razavian" },
      { name: "description", content: "How Dr. Amineh Razavian's practice collects, uses and protects your personal information." },
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24 prose-sm">
      ...
      <div className="mt-8 space-y-5 text-sm text-foreground/85 leading-relaxed">
        <p>This privacy policy explains how Dr. Amineh Razavian's practice ("we", "our") collects, uses and safeguards information you provide when you use this website or book a consultation.</p>
